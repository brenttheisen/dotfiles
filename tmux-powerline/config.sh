...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="wasted"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/lw/x872ln513lj6t6c_fj1n7cq00000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/brent/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/brent/.mailcheckrc"
# }
...
# time.sh {
    ...
    export TMUX_POWERLINE_SEG_TIME_FORMAT="%l:%M:%S %p"
